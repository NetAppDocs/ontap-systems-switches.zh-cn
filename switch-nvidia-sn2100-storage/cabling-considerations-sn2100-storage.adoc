...
summary: 在部署之前，请查看 NVIDIA SN2100 存储交换机的布线和配置注意事项。 
---
= 查看 NVIDIA SN2100 存储交换机的布线和配置注意事项
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在部署之前，请查看 NVIDIA SN2100 存储交换机的布线和配置注意事项。
...
--
====
有关更多详细信息，请参见知识库文章 link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Systems/Fabric_Interconnect_and_Management_Switches/NVIDIA_SN2100_switch_fails_to_connect_using_40_100GbE_copper_cable["SN2100交换机无法使用40/100GbE铜缆连接"^]。
