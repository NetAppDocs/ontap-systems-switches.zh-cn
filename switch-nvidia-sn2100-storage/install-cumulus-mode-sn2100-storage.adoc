...
summary: 当交换机在 Cumulus 模式下运行时，在 NVIDIA SN2100 存储交换机上安装 Cumulus Linux。 
---
= 在 NVIDIA SN2100 存储交换机上以 Cumulus 模式安装 Cumulus Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当 NVIDIA SN2100 存储交换机在 Cumulus 模式下运行时，在其上安装 Cumulus Linux (CL)。


NOTE: 可以在交换机运行 Cumulus Linux 或 ONIE 时安装 Cumulus Linux (CL) 操作系统（请参阅 link:install-onie-mode-sn2100-storage.html["以 ONIE 模式安装"]）。
...
----
+
有关更多详细信息，请参见知识库文章 link:https://kb.netapp.com/on-prem/Switches/Nvidia-KBs/NTP_Server_configuration_is_not_working_with_NVIDIA_SN2100_Switches["NTP 服务器配置与NVIDIA SN2100 交换机不兼容。"^]。
...
----
+
请参见 link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-54/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["NVIDIA用户帐户"^] 了解更多信息。
...
请参见 link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-511/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["NVIDIA用户帐户"^] 了解更多信息。
