...
summary: 使用交换机随附的标准支架，在 NetApp 机柜中安装 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机以及直通面板。 
---
= 在 NetApp 机柜中安装 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用交换机随附的标准支架，在 NetApp 机柜中安装 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机以及直通面板。

.开始之前
请确保您拥有以下物品：

* 对于每个开关，您必须提供八个 10-32 或 12-24 螺钉和夹紧螺母，以便将支架和滑轨安装到柜体的前后立柱上。
* 必须使用Cisco标准导轨套件才能将交换机安装到NetApp机柜中。
...
.所需文件
请查阅初始准备要求、工具包内容和安全注意事项。 https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/aci_9336cfx2_hig/guide/b_n9336cFX2_aci_hardware_installation_guide.html["Cisco Nexus 9000 系列硬件安装指南"^] 。

.步骤
. 在NetApp机柜中安装直通式盲板。
+
NetApp提供直通面板套件（部件号 X8784-R6）。
...
+
两台 9336C-FX2 交换机将始终安装在机柜 RU41 和 42 的顶部 2U 中。
...
. 将每个 9336C-FX2 交换机上的管理端口连接到任一管理交换机（如果订购）或将其直接连接到管理网络。
+
...
.下一步
在将交换机安装到NetApp机柜后，您可以……link:setup-switch-9336c-storage.html["配置Cisco Nexus 9336C-FX2 和 9336C-FX2-T 交换机"] 。
