...
summary: 在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机上安装或升级 NX-OS 软件。 
---
= 在 Cisco Nexus 9336C-FX2 存储交换机上安装或升级 NX-OS 软件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机上安装或升级 NX-OS 软件。必须先安装 NX-OS，然后才能配置交换机或安装参考配置文件 (RCF)。
