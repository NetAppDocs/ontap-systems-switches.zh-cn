...
summary: 更换存储网络中有缺陷的 Cisco Nexus 9336C-FX2 或 9336C-FX2-T 存储交换机。此操作不会造成中断。 
---
...
[role="lead"]
更换存储网络中存在缺陷的 Cisco Nexus 9336C-FX2 或 9336C-FX2-T 存储交换机，而不会中断存储网络运行。此无中断过程 (NDU) 涉及准备更换交换机和恢复存储网络配置。
