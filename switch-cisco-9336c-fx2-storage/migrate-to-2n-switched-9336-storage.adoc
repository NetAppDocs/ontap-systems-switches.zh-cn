...
summary: 使用 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机将现有的双节点无交换机集群迁移到交换机集群环境。 
---
= 使用 Cisco Nexus 9336C-FX2 存储交换机迁移到双节点交换集群
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机将现有的双节点无交换机集群迁移到交换机集群环境。这种无中断迁移使您能够将集群扩展到两个节点以上。
