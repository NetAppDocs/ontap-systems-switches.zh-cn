...
.下一步是什么？
您也可以选择 link:install-switch-and-passthrough-panel-9336c-storage.html["在NetApp机柜中安装Cisco Nexus 9336C-x2交换机"]。否则，请转到 link:install-nxos-overview-9336c-storage.html["准备安装NX-OS和RCF"]。
