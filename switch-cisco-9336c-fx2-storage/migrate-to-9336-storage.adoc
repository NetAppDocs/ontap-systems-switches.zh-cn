...
summary: 将较旧的 Cisco 交换机迁移到 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机，而不会中断存储网络运行。 
---
= 从旧 Cisco 交换机迁移到 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将较旧的 Cisco 交换机迁移到 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机，而不会中断存储网络运行。
