...
summary: '当有较新版本可用时，升级 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机上的参考配置文件 (RCF)。' 
---
= 升级 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机上的 RCF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当有较新版本的 RCF 可用时，升级 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 存储交换机上的参考配置文件 (RCF)。
...
. 验证连接到节点存储端口和存储架端口的交换机端口是否为 *up* 状态。
+
[source, cli]
----
