...
[role="lead"]
对于Cisco Nexus 92300YC交换机安装和维护、请务必查看所有要求和建议的文档。
...
要设置Cisco Nexus 92300YC交换机和ONTAP 集群、您需要特定的交换机和控制器文档。
...
介绍与 42U 系统机柜关联的 FRU ，并提供维护和 FRU 更换说明。
 ...
 a| 
link:install-switch-and-passthrough-panel.html["在NetApp机柜中安装Cisco Nexus 92300YC交换机"]
 a| 
