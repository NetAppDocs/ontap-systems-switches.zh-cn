...
+
参见link:https://hwu.netapp.com/Home/Index["硬件宇宙"]针对您的平台实际支持的集群端口。看 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安装HWU中没有的设备还需要哪些额外信息？"^] 有关交换机安装要求的更多信息。
...
.下一步是什么？
安装完 NX-OS 软件后，您可以…… link:install-the-rcf-file.html["安装参考配置文件"]。
