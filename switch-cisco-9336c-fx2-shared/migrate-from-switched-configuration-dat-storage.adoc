...
keywords:  
summary: 通过添加两台新的共享交换机，从具有直连存储的交换机配置迁移到 Cisco Nexus 9336C-FX2 共享交换机。 
---
= 从具有直连存储的交换机配置迁移到 Cisco Nexus 9336C-FX2 共享交换机
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
通过添加两台新的共享交换机，从具有直连存储的交换机配置迁移到 Cisco Nexus 9336C-FX2 共享交换机。
...
此过程中支持的 ONTAP 和 NX-OS 版本位于 Cisco 以太网交换机页面。请参阅 https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco以太网交换机"^]。
...
link:https://hwu.netapp.com["Hardware Universe"^] 包含有关所有集群交换机支持的布线的信息。
