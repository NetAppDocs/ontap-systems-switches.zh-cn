...
summary: 使用交换机随附的标准支架在 NetApp 机柜中安装 Cisco Nexus 9336C-FX2 共享交换机和直通面板。 
---
= 在 NetApp 机柜中安装 Cisco Nexus 9336C-FX2 共享交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用交换机随附的标准支架在 NetApp 机柜中安装 Cisco Nexus 9336C-FX2 共享交换机和直通面板。
