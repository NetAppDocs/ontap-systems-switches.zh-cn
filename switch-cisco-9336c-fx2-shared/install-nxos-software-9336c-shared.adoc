...
summary: 在 Cisco Nexus 9336C-FX2 共享交换机上安装 NX-OS 软件，为共享集群和存储操作做好准备。 
---
= 在 Cisco Nexus 9336C-FX2 共享交换机上安装 NX-OS 软件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Cisco Nexus 9336C-FX2 共享交换机上安装 NX-OS 软件，为共享集群和存储操作做好准备。
