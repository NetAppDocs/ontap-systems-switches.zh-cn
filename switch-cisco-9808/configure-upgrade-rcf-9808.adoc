...
summary: '您可以升级 Cisco Nexus 9808 交换机上的参考配置文件 (RCF) 版本，以支持新硬件、新 ONTAP 版本或与 AFX 2K 系统配置中的新 NX-OS 版本保持一致。' 
---
= 升级 RCF 版本 - Cisco Nexus 9808
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以升级 Cisco Nexus 9808 交换机上的参考配置文件 (RCF) 版本，以支持新硬件、新 ONTAP 版本或与 AFX 2K 系统配置中的新 NX-OS 版本保持一致。
