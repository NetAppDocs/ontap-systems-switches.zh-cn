...
summary: 您可以在 Cisco Nexus 9808 交换机上安装 NX-OS，作为新 AFX 2K 系统安装、supervisor 模块更换或交换机重置为出厂默认设置的一部分。 
---
= 安装 NX-OS - Cisco Nexus 9808
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以在 Cisco Nexus 9808 交换机上安装 NX-OS，作为新 AFX 2K 系统安装、supervisor 模块更换或交换机重置为出厂默认设置的一部分。
