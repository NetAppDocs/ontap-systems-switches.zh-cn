...
summary: 升级 Cisco Nexus 9808 交换机上的 NX-OS，以支持 AFX 2K 系统上的新硬件或新 ONTAP 版本。 
---
= 在 Cisco Nexus 9808 交换机上升级 NX-OS
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
升级 Cisco Nexus 9808 交换机上的 NX-OS，以支持 AFX 2K 系统上的新硬件或新 ONTAP 版本。
...
通过安装和验证新版本的 NX-OS 和 EPLD、验证集群上所有端口的运行状况，在第一台交换机 （cs1） 上安装 NX-OS，然后在第二台交换机 （cs2） 上重复这些步骤。
