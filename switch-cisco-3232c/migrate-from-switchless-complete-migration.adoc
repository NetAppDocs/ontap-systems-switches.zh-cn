...
summary: 完成从双节点无交换机集群到 Cisco Nexus 3232C 集群交换机的迁移。 
---
= 完成从双节点无交换机集群到 Cisco Nexus 3232C 集群交换机的迁移
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
完成最后步骤，使用 Cisco Nexus 3232C 集群交换机从双节点无交换机集群迁移到双节点交换机集群。
...
--
====
. [[step7]] 如果您禁止自动创建案例，请通过调用 AutoSupport 消息重新启用它：
+
...
.下一步是什么？
完成交换机迁移后，您可以 link:../switch-cshm/config-overview.html["配置交换机健康监控"]。
