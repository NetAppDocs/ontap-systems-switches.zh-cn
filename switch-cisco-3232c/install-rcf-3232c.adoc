...
您也可以使用此过程升级您的 RCF 版本。请参阅知识库文章 https://kb.netapp.com/onprem/Switches/Cisco/How_to_clear_configuration_on_a_Cisco_interconnect_switch_while_retaining_remote_connectivity["如何在保持远程连接的情况下清除Cisco互连交换机上的配置"^]有关升级 RCF 的更多信息。
