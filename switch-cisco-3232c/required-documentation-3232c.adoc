...
summary: 对于Cisco Nexus 3232C交换机安装和维护、请务必查看所有建议文档。 
---
= Cisco Nexus 3232C交换机的文档要求
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
对于Cisco Nexus 3232C交换机安装和维护、请务必查看所有建议文档。



== 交换机文档

要设置Cisco Nexus 3232C交换机、您需要中的以下文档 https://["Cisco Nexus 3000 系列交换机支持"^] 页面。
...
介绍与 42U 系统机柜关联的 FRU ，并提供维护和 FRU 更换说明。
 ...
 a| 
link:install-cisco-nexus-3232c.html["在NetApp机柜中安装Cisco Nexus 3232C交换机"^]
 a| 
