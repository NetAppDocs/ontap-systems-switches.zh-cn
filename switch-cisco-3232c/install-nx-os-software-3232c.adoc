...
summary: 在 Cisco Nexus 3232C 集群交换机上安装 NX-OS 软件，为集群运行做好准备。 
---
= 在 Cisco Nexus 3232C 集群交换机上安装 NX-OS 软件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Cisco Nexus 3232C 集群交换机上安装 NX-OS 软件，为集群运行做好准备。
...
+
有关更多详细信息，请参阅 link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLD 升级版本说明，版本 9.3(11)"^]。
...
.下一步是什么？
安装 NX-OS 软件后，您可以link:install-upgrade-rcf-overview-3232c.html["安装或升级参考配置文件（RCF）"]。
