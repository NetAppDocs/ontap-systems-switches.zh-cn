...
----
====
. 如果要升级到NX-OS 9.3 (11)版、则必须升级EPLD `golden`映像并重新启动交换机。否则、请跳至步骤12。
+
有关详细信息、请参见 https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLD升级发行说明、9.3 (11)版"^]。
...
.下一步是什么？
link:install-rcf-3232c.html["安装RCF配置文件"](英文)
