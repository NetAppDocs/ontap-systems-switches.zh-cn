...
NOTE: Cumulus Linux (CL) 操作系统可以在交换机运行 Cumulus Linux 或 ONIE 时安装（参见link:install-onie-mode-sn2100-cluster.html["以 ONIE 模式安装"]）。
...
====
.下一步是什么？
在 Cumulus 模式下安装 Cumulus Linux 后，您 link:install-rcf-sn2100-cluster.html["安装参考配置文件 (RCF) 脚本"]。
