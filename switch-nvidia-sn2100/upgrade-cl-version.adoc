...
summary: 升级 NVIDIA SN2100 集群交换机上的 Cumulus Linux 版本，以保持与 ONTAP 的兼容性并访问最新的软件功能。 
---
= 在 NVIDIA SN2100 集群交换机上升级 Cumulus Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
升级 NVIDIA SN2100 集群交换机上的 Cumulus Linux 版本，以保持与 ONTAP 的兼容性并访问最新的软件功能。
...
有关详细信息，请参见 link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-510/Installation-Management/Installing-a-New-Cumulus-Linux-Image/["安装新的 Cumulus Linux 镜像"^]。
...
----
+
有关详细信息，请参见 link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-54/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["NVIDIA用户帐户"^]。
