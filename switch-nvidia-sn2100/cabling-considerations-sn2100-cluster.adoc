...
summary: 在部署之前，请查看 NVIDIA SN2100 集群交换机的布线和配置注意事项。 
---
= 查看 NVIDIA SN2100 集群交换机的布线和配置注意事项
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在部署之前，请查看 NVIDIA SN2100 集群交换机的布线和配置注意事项。
...
--
====
有关详细信息，请参见 link:https://hwu.netapp.com/Switch/Index["Hardware Universe"^] 和知识库文章 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安装我的设备（HWU中没有包含这些信息）还需要哪些其他信息？"^]。

.下一步是什么？
在您审核完布线和配置要求后，您可以link:install-cable-shelves-sn2100-cluster.html["将 NS224 货架连接成交换机连接的存储设备"]。
