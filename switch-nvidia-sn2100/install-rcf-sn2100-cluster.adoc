...
* 安装了Cumulus Linux。请参见 https://["Hardware Universe"^] 支持的版本。
* 通过DHCP定义或手动配置的IP地址、子网掩码和默认网关。


.当前RCF脚本版本
集群和存储应用程序可以使用两个RC框架 脚本。从下载RCF https://["此处"^]。每个的操作步骤 是相同的。
...
NOTE: 对于无法更正的任何RCF python脚本问题、请联系 https://["NetApp 支持"^] 以获得帮助。
