...
IMPORTANT: 有关注意事项和详细信息，请参见 link:cabling-considerations-sn2100-cluster.html["审查布线和配置注意事项"]。link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe- 交换机"^] 还包含有关布线的详细信息。
