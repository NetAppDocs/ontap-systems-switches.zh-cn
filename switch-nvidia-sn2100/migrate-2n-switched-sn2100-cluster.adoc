...
summary: 使用 NVIDIA SN2100 集群交换机将现有的双节点无交换机集群迁移到有交换机的集群环境。 
---
...
[role="lead"]
使用 NVIDIA SN2100 集群交换机将现有的双节点无交换机集群迁移到有交换机集群环境。这种无中断迁移使您能够将集群扩展到两个节点以上。
...
IMPORTANT: 有关注意事项和更多详细信息，请参见 link:cabling-considerations-sn2100-cluster.html["查看布线和配置指南"]。link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe- 交换机"^] 还包含有关布线的详细信息。
