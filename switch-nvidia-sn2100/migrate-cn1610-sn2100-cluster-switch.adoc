...
summary: 将现有的 NetApp CN1610 集群交换机迁移到 NVIDIA SN2100 集群交换机，而不会中断集群操作。 
---
= 从 NetApp CN1610 集群交换机迁移到 NVIDIA SN2100 集群交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将现有的 NetApp CN1610 集群交换机迁移到 NVIDIA SN2100 集群交换机，而不会中断集群操作。
...
在将 NetApp CN1610 集群交换机更换为 NVIDIA SN2100 集群交换机时，您必须了解某些配置信息、端口连接和布线要求。请参阅 link:configure-overview-sn2100-cluster.html["NVIDIA SN2100交换机的安装和配置概述"]。
