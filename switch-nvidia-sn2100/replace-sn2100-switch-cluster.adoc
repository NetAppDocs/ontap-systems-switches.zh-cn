...
summary: 更换集群网络中存在故障的 NVIDIA SN2100 集群交换机。这是一个无中断操作步骤。 
---
= 更换 NVIDIA SN2100 集群交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在不中断集群运行的情况下，更换集群网络中有缺陷的 NVIDIA SN2100 集群交换机。此无中断程序 (NDU) 涉及准备替换交换机以及从故障交换机迁移连接。
