...
.下一步是什么？
或者，您可以link:install-switch-and-passthrough-panel-9336c-cluster.html["在NetApp机柜中安装Cisco Nexus 9336C-x2交换机"]。否则，转到link:cabling-considerations-9336c-fx2.html["检查布线和配置"]。
