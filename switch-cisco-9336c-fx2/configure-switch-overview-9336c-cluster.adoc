...
summary: 按照此工作流程在 ONTAP 环境中安装和配置 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机。 
---
...
[role="lead"]
按照此工作流程在 ONTAP 环境中安装和配置 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机。这些交换机是 Cisco Nexus 9000 平台的一部分，支持具有两个以上节点的 ONTAP 集群。
