...
summary: 将 NetApp CN1610 集群交换机迁移到 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机，而不会中断集群操作。 
---
= 从 NetApp CN1610 集群交换机迁移到 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将现有的 NetApp CN1610 集群交换机迁移到 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机，而不会中断集群操作。
...
有关支持的端口及其配置的详细信息，请参见 link:https://hwu.netapp.com/["Hardware Universe"^]。有关交换机安装要求的更多信息，请参见 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安装HWU中没有的设备还需要哪些额外信息？"^]。
