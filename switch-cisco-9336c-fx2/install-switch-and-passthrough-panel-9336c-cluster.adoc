...
summary: 使用交换机随附的标准支架在 NetApp 机柜中安装 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机以及直通面板。 
---
= 在 NetApp 机柜中安装 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用交换机随附的标准支架在 NetApp 机柜中安装 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机以及直通面板。
...
* 有关初始制备要求、试剂盒内容和安全注意事项，请参阅 link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/aci_9336cfx2_hig/guide/b_n9336cFX2_aci_hardware_installation_guide.html["Cisco Nexus 9000 系列硬件安装指南"^]。
