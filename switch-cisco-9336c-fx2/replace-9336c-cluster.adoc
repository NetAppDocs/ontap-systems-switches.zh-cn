...
summary: 更换集群网络中存在故障的 Cisco Nexus 9336C-FX2 或 9336C-FX2-T 集群交换机。这是一个无中断操作步骤。 
---
...
[role="lead"]
在不中断集群运行的情况下，更换集群网络中有缺陷的 Cisco Nexus 9336C-FX2 或 9336C-FX2-T 集群交换机。此无中断程序（NDU）涉及准备更换交换机以及从故障交换机迁移连接。
