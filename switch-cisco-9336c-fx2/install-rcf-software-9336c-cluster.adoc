...
summary: '初始设置后，在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机上安装参考配置文件 (RCF)，以配置端口分配、VLAN 和网络设置。' 
---
= 在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机上安装 RCF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
初始设置后，在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机上安装参考配置文件 (RCF)。RCF 定义了集群操作所需的端口分配、VLAN 和网络设置。
...
. 使用以下传输协议之一将 RCF 复制到交换机 cs1 的 bootflash：FTP、SFTP 或 SCP。
+
