...
summary: 使用 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机将现有的双节点无交换机集群迁移到交换集群环境。 
---
= 使用 Cisco Nexus 9336C-FX2 集群交换机迁移到双节点交换集群
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机将现有的双节点无交换机集群迁移到有交换机的集群环境。这种无中断迁移使您能够将集群扩展到两个节点以上。
...
有关平台的集群端口信息，请参见 link:https://hwu.netapp.com["Hardware Universe"^]。有关交换机安装要求的详细信息，请参见 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安装HWU中没有的设备还需要哪些额外信息？"^]。
...
[%collapsible]
====
以下示例显示了 node1 和 node2 上的所有 LIF 都已启动：
