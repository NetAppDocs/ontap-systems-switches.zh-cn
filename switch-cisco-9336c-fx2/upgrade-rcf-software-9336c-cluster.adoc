...
summary: '当有更新版本时，升级 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机上的参考配置文件 (RCF)。' 
---
= 升级 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机上的 RCF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当有较新版本的 RCF 时，升级 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机上的参考配置文件 (RCF)。
...
. 使用以下传输协议之一将 RCF 复制到交换机 cs1 上的 bootflash：FTP、SFTP 或 SCP。
+
有关 Cisco 命令的更多信息，请参见 link:https://www.cisco.com/c/en/us/support/switches/nexus-9336c-fx2-switch/model.html#CommandReferences["Cisco Nexus 9000 系列 NX-OS 命令参考"^] 中的相应指南。

+
此示例显示使用 SFTP 将 RCF 复制到交换机 cs1 上的 bootflash：
...
CAUTION: 如果 9336C-FX2 交换机在 RCF 升级后无法启动，请参见 NetApp 知识库文章 link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Cisco_9336C-FX2_Switch_Fails_to_Boot_After_RCF_Install_%E2%80%93_Boot_Variable_Cleared["Cisco 9336C-FX2 交换机在安装 RCF 后无法引导 – 引导变量已清除"^] 以了解后续步骤。
