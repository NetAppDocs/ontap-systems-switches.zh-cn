...
[role="lead"]
您可以从旧版Cisco集群交换机无中断迁移到Cisco Nexus 9336C-x2集群网络交换机。
...
* 您可以访问上的交换机兼容性表 https://["Cisco 以太网交换机"^] 页面上显示了受支持的 ONTAP ， NX-OS 和 RCF 版本。
* 您已查看Cisco网站上有关Cisco交换机升级和降级过程的相应软件和升级指南、网址为 https://["Cisco Nexus 9000 系列交换机支持"^] 页面。
...
.关于此任务
操作步骤 需要同时使用ONTAP 命令和 https://["Nexus 9000系列交换机"^] 命令；除非另有说明、否则使用ONTAP 命令。
