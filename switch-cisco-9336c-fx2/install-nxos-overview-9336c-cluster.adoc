...
summary: '在安装 NX-OS 软件和参考配置文件 (RCF) 之前，请准备 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机。' 
---
= 准备在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机上安装 NX-OS 软件和 RCF
:allow-uri-read: 


[role="lead"]
在安装 NX-OS 软件和参考配置文件 (RCF) 之前，请准备好 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 集群交换机。必须先安装 NX-OS 和 RCF，交换机才能在 ONTAP 集群中运行。
