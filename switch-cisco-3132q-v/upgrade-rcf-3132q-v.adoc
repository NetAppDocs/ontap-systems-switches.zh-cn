...
NOTE: 有关如何在 RCF 升级后使 10GbE 端口联机的步骤，请参见知识库文章 link:https://kb.netapp.com/onprem%2FSwitches%2FCisco%2F10GbE_ports_on_Cisco_3132Q_cluster_switch_do_not_come_online["Cisco 3132Q 集群交换机上的 10GbE 端口无法联机"^]。
