...
[role="lead"]
您可以使用此操作步骤 在 Nexus 3132Q-V 集群交换机上安装 NX-OS 软件。
...
----
. 使用以下传输协议之一将NX-OS软件复制到Nexus 3132Q-V交换机：FTP、TFTP、SFTP或SCP。有关 Cisco 命令的详细信息，请参见中的相应指南 https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["《 Cisco Nexus 3000 系列 NX-OS 命令参考》"^] 指南。
+
此示例显示了用于将NX-OS软件复制到Nexus 3132Q-V交换机的SFTP：
