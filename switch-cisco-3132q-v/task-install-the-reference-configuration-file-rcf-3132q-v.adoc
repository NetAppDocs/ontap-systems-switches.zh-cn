...
summary: 您可以在首次设置 Nexus 3132Q-V 交换机后安装 RCF 。您也可以使用此操作步骤 升级 RCF 版本。 
---
= 安装参考配置文件（ RCF ）
:allow-uri-read: 
:icons: font
...
[role="lead"]
首次设置 Nexus 3132Q-V 交换机后，您可以安装 RCF 。您也可以使用此操作步骤升级 RCF 版本。
...
+
此示例显示了 RCF 文件 `Nexus 3132QV_RCF_v1.6-Cluster-HA-Breakout 。 txt` 正在交换机 CS2 上安装：
