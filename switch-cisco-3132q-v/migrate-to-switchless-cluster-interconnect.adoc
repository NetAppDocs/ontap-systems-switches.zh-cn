...
summary: 将 Cisco Nexus 3132Q-V 集群交换机替换为适用于 ONTAP 9.3 及更高版本的无交换机连接。 
---
= 用无交换机连接取代 Cisco Nexus 3132Q-V 集群交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 ONTAP 9.3 及更高版本中，通过将 Cisco Nexus 3132Q-V 集群交换机替换为直接连接，从具有交换互连的集群迁移到两个节点直接连接的集群。

[NOTE]
====
NetApp 建议您在继续 Cisco Nexus 3132Q-V 交换机的有交换机切换到无交换机集群操作之前更新您的 ONTAP 版本。

有关更多详细信息，请参见以下内容：

* link:https://kb.netapp.com/Support_Bulletins/Customer_Bulletins/SU540["SU540：从 40G 升级到 100G 网络交换机时，Chelsio T6 NIC 错误导致系统关闭"^]
* link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Node_panic_after_migration_from_switched_to_switchless_cluster["从有交换机集群迁移到无交换机集群后节点崩溃"^]
