...
summary: 您可以按照以下步骤在 Nexus 3132Q-V 集群交换机上安装 NX-OS 软件。 
---
= 安装 NX-OS 软件
:allow-uri-read: 
:icons: font
...
[role="lead"]
按照以下步骤在 Nexus 3132Q-V 集群交换机上安装 NX-OS 软件。
...
.建议的文档
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco以太网交换机"^]。请查阅交换机兼容性表格，了解支持的ONTAP和 NX-OS 版本。
