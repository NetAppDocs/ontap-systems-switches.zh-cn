...
summary: 在 Cisco Nexus 3132Q-V 集群交换机上安装 NX-OS 软件，为集群操作做好准备。 
---
= 在 Cisco Nexus 3132Q-V 集群交换机上安装 NX-OS 软件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Cisco Nexus 3132Q-V 集群交换机上安装 NX-OS 软件，为集群操作做好准备。
...
.建议的文档
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco 以太网交换机"^]。有关支持的 ONTAP 和 NX-OS 版本，请参见交换机兼容性表。
* https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000系列交换机"^]。有关 Cisco 交换机升级和降级过程的完整文档，请参阅 Cisco 网站上提供的相应软件和升级指南。
...
请务必完成 link:prepare-install-cisco-nexus-3132q.html["准备安装 NX-OS 软件和参考配置文件"] 中的步骤，然后按照以下步骤操作。
...
. 使用以下传输协议之一将 NX-OS 软件复制到 Nexus 3132Q-V 交换机：FTP、TFTP、SFTP 或 SCP。有关 Cisco 命令的详细信息，请参阅 link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 系列 NX-OS 命令参考"^] 中的相应指南。
+
.显示示例
[%collapsible]
====
...
.下一步是什么？
安装 NX-OS 软件后，您可以link:install-upgrade-rcf-overview-3132q-v.html["安装或升级参考配置文件（RCF）"]。
