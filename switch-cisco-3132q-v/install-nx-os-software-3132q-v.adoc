...
. 使用以下传输协议之一将 NX-OS 软件复制到 Nexus 3132Q-V 交换机：FTP、TFTP、SFTP 或 SCP。有关Cisco命令的更多信息，请参阅相应的指南。 https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 系列 NX-OS 命令参考指南"^] 。
+
.显示示例
[%collapsible]
====
