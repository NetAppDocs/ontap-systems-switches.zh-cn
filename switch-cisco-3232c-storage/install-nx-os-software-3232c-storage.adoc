...
summary: 在 Cisco Nexus 3232C 存储交换机上安装或升级 NX-OS 软件。 
---
= 在 Cisco Nexus 3232C 存储交换机上安装或升级 NX-OS 软件
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Cisco Nexus 3232C 存储交换机上安装或升级 NX-OS 软件，为存储网络操作做好准备。
...
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco以太网交换机页面"^]。有关支持的 ONTAP 和 NX-OS 版本，请参见交换机兼容性表。
...
----
====
. 如果您要升级到 NX-OS 版本 9.3(11)，则必须升级 EPLD `golden` 映像并再次重新启动交换机。否则，请跳至第 12 步。
+
请参见 https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLD 升级版本说明，版本 9.3(11)"^]以了解详细信息。
