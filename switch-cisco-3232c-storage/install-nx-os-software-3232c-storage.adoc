...
.开始之前
验证您是否具有以下内容：* 交换机配置的当前备份。* 功能齐全的集群（日志中没有错误或类似问题）。* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco以太网交换机页面"^]。有关支持的 ONTAP 和 NX-OS 版本，请参见交换机兼容性表。* link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["CiscoNexus 3000 系列交换机"^]。有关 Cisco 交换机升级和降级过程的完整文档，请参见 Cisco 网站上提供的相应软件和升级指南。
