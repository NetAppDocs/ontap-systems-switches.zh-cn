...
summary: '当有较新版本可用时，升级 Cisco Nexus 3232C 存储交换机上的参考配置文件 (RCF)。' 
---
= 升级 Cisco Nexus 3232C 存储交换机上的 RCF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
当有较新版本的 RCF 时，升级 Cisco Nexus 3232C 存储交换机上的参考配置文件 (RCF)。
...
CAUTION: 请务必关闭*所有*连接的端口，以避免任何网络连接问题。有关更多详细信息，请参阅知识库文章 https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Node_out_of_quorum_when_migrating_cluster_lif_during_switch_OS_upgrade["在切换操作系统升级期间迁移集群 LIF 时，节点脱离仲裁。"^]。
...
+
请参见知识库文章link:https://kb.netapp.com/on-prem/Switches/Cisco-KBs/How_to_clear_configuration_on_a_Cisco_interconnect_switch_while_retaining_remote_connectivity["如何在保持远程连接的情况下清除Cisco互连交换机上的配置"^]以了解详细信息。
