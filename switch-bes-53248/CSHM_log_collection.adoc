...
summary: 在 Broadcom BES-53248 集群交换机上配置日志收集，使 CSHM 能够收集用于调试和 AutoSupport 报告的交换机日志。 
---
= 为 Broadcom BES-53248 集群交换机配置日志收集
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Broadcom BES-53248 集群交换机上配置日志收集，使以太网交换机健康监视器 (CSHM) 能够收集用于调试和 AutoSupport 报告的交换机日志。此过程设置按需支持日志收集和每小时定期数据收集。
