...
summary: 执行 Broadcom BES-53248 集群交换机的初始配置，以便为 EFOS 软件安装和集群部署做好准备。 
---
= 配置 Broadcom BES-53248 集群交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
执行 Broadcom BES-53248 集群交换机的初始配置，为 EFOS 软件安装和集群部署做好准备。
...
* 每个节点上的集群端口都被命名为 `e0a`和 `e0b`。有关您平台上支持的实际集群端口，请参见link:https://hwu.netapp.com/Home/Index["Hardware Universe"^]。
