...
summary: '在 Broadcom BES-53248 集群交换机上配置 SNMPv3，以实现与以太网交换机运行状况监控器 (CSHM) 的安全通信。' 
---
= 为 Broadcom BES-53248 集群交换机配置 SNMPv3
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Broadcom BES-53248 集群交换机上配置 SNMPv3，以实现与以太网交换机运行状况监视器 (CSHM) 的安全、经过身份验证的通信。SNMPv3 为 ONTAP 中的运行状况监控提供交换机状态的加密轮询。
