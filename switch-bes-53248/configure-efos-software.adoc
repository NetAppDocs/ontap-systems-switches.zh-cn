...
.开始之前
* 从下载适用于集群交换机的Broadcom EFOS软件 https://["Broadcom 以太网交换机支持"^] 站点
* 查看以下有关EFOS版本的注释。
...
IMPORTANT: 请注意，将 BES-53248 集群交换机从 EFOS 3.3.x.x 或 3.4.x.x 升级到 EFOS 3.7.0.4 或 3.8.0.2 后，交换机间链路（ ISL ）和端口通道将标记为 * 关闭 * 状态。请参见此知识库文章： https://["BES-53248集群交换机NDU无法升级到EFOS 3.7.0.4及更高版本"^] 了解更多详细信息。
