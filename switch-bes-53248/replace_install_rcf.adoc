...
NOTE: 根据您的环境、您可能需要在copy命令中使用双斜杠、例如：`+copy sftp：//172.19.2.1//tmp/BES-53248_RCF_v1.6-Cluster-HA.txt nvram：script BES-53248_RCF_v1.6-Cluser-HA.SCR+`。
...
NOTE: 在第一台交换机上安装RCF后、重复这些步骤、在第二台集群交换机上安装RCF。


CAUTION: 请参见此内容 link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Protection_and_Security/MetroCluster/BES-53248_communication_issue_after_firmware%2F%2FRCF_upgrade["知识库"^] 有关安装适用于MetroCluster 的RCF的详细信息、请参见。
