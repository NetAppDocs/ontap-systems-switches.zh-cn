...
summary: 按照迁移要求和程序，将现有的 NetApp CN1610 集群交换机迁移到 Broadcom BES-53248 集群交换机。 
---
= 从 NetApp CN1610 集群交换机迁移到 Broadcom BES-53248 集群交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
将现有的 NetApp CN1610 集群交换机迁移到 Broadcom BES-53248 集群交换机。查看迁移要求，然后按照迁移程序更换交换机，而不会中断集群操作。
...
link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] 包含有关 ONTAP 兼容性、支持的 EFOS 固件以及连接到 BES-53248 集群交换机的布线信息。有关交换机安装要求的详细信息，请参见 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安装HWU中没有的设备还需要哪些额外信息？"^]。
