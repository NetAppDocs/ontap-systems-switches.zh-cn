...
这 link:https://hwu.netapp.com/Home/Index["NetApp硬件世界"^] 包含有关ONTAP兼容性、支持的 EFOS 固件以及与 BES-53248 集群交换机的布线的信息。看 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安装HWU中没有的设备还需要哪些额外信息？"^] 有关交换机安装要求的更多信息。
