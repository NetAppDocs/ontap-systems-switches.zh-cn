...
summary: Broadcom BES-53248 集群交换机基本型号支持 16 个 10GbE 或 25GbE 端口和两个 100GbE 端口。安装额外的端口许可证以扩展交换机容量。 
---
= 为 Broadcom BES-53248 集群交换机安装许可证
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Broadcom BES-53248 集群交换机基本型号已获授权，支持 16 个 10GbE 或 25GbE 端口以及两个 100GbE 端口。安装其他端口许可证，以扩展交换机，从而支持更多 10GbE 或 25GbE 集群端口。
...
NOTE: 要将事务密钥兑换为端口许可证密钥文件，请参阅 link:https://support.broadcom.com/web/csg/license-generation["博通支持的以太网交换机的许可门户"^]。有关更多详细信息，请参阅知识库文章 link:https://kb.netapp.com/on-prem/Switches/Broadcom-KBs/How_to_add_Additional_Port_Licensing_for_the_Broadcom_BES_53248_Switch["如何为博通 BES-53248 交换机添加额外的端口许可"^]。
