...
summary: 使用 Broadcom BES-53248 集群交换机将双节点无交换机集群迁移到有交换机集群环境，以实现超过两个节点的扩展。 
---
= 使用 Broadcom BES-53248 集群交换机迁移到双节点交换集群
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用 Broadcom BES-53248 集群交换机将现有的双节点无交换机集群迁移到有交换机集群环境。这种无中断迁移使您能够将集群扩展到两个节点以上。
...
+
link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] 包含有关 ONTAP 兼容性、支持的 EFOS 固件以及到 BES-53248 交换机的电缆连接的信息。有关交换机安装要求的详细信息，请参见 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安装HWU中没有的设备还需要哪些额外信息？"^]。
...
+
link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] 包含有关您平台的实际集群端口的最新信息。
...
+
link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] 包含有关布线的详细信息。
