...
summary: 升级 Cisco Nexus 9332D-GX2B 交换机上的 NX-OS，以支持 AFX 1K 或 AFX 2K 系统上的新硬件或新 ONTAP 版本。 
---
= 在 Cisco Nexus 9332D-GX2B 交换机上升级 NX-OS
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
升级 Cisco Nexus 9332D-GX2B 交换机上的 NX-OS，以支持 AFX 1K 或 AFX 2K 系统上的新硬件或新 ONTAP 版本。
...
.下一步是什么？
升级交换机上的 NX-OS 后，请从 link:configure-install-upgrade-rcf-overview-9332d.html["安装或升级 RCF 概述"] 开始升级 RCF。
