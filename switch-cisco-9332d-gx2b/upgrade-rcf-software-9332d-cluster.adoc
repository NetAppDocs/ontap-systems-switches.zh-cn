...
.. 对于 NX-OS 10.2 及更高版本，使用 `show diff running-config`命令与 Bootflash 中保存的 RCF 文件进行比较。否则，请使用第三方差异/比较工具。
...
+
此示例显示 RCF 文件 `NX9332D-GX2B-RCF-v10.0-Shared.txt`正在交换机 cs1 上安装：
