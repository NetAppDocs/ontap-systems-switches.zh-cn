...
** 看 https://hwu.netapp.com["Hardware Universe"^]适用于所有受支持的ONTAP版本。
...
+
看 https://hwu.netapp.com["Hardware Universe"^]有关布线的更多信息。
...
看 https://hwu.netapp.com["Hardware Universe"^]有关您平台集群端口的信息。看 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安装HWU中没有的设备还需要哪些额外信息？"^] 有关交换机安装要求的更多信息。
