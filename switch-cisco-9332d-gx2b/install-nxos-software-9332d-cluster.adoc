...
* 完成该程序link:install-nxos-overview-9332d-cluster.html["准备安装 NX-OS 和 RCF"]。
* 交换机配置的当前备份。
...
.下一步是什么？
在安装或升级 NX-OS 软件后，您可以link:install-upgrade-rcf-overview-cluster-9332d.html["安装或升级参考配置文件（RCF）"]。
