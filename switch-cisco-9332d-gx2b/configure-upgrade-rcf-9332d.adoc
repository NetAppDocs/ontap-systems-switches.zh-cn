...
summary: 升级 Cisco Nexus 9332D-GX2B 交换机上的 RCF，以支持 AFX 1K 或 AFX 2K 系统上的新硬件、新 ONTAP 版本或新 NX-OS 版本。 
---
= 升级 Cisco Nexus 9332D-GX2B 交换机上的 RCF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
升级 Cisco Nexus 9332D-GX2B 交换机上的参考配置文件 (RCF)，以支持 AFX 1K 或 AFX 2K 系统上的新硬件、新 ONTAP 版本或新 NX-OS 版本。
