...
summary: '必须在Cisco Nexus 9332D-GX2B 集群交换机上安装Cisco NX-OS 软件和参考配置文件 \(RCFs\)。' 
---
= 准备安装 NX-OS 软件和 RCF
:allow-uri-read: 
...
.下一步是什么？
准备好安装 NX-OS 软件和 RCF 后，您 link:install-nxos-software-9332d-cluster.html["安装或升级 NX-OS 软件"]。
