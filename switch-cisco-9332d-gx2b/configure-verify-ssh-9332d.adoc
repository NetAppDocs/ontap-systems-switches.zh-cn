...
summary: '如果要将交换机配置为新的 AFX 1K 或 AFX 2K 系统安装、交换机更换或重置为出厂默认设置的一部分，并且要使用集群交换机运行状况监视器 (CSHM) 和日志收集功能，则必须验证交换机上是否已启用 SSH 和 SSH 密钥。' 
---
= 验证日志收集的 SSH - Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
** 配置以太网交换机运行状况监控后，如果您想利用 Cisco 的 Smart Call Home 支持功能，您link:configure-smart-call-9332d.html["配置 Smart Call Home"]。
