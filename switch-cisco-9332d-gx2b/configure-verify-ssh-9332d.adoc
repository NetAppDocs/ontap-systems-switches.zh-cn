...
summary: '确认已在 Cisco Nexus 9332D-GX2B 交换机上启用 SSH，以支持以太网交换机运行状况监视器 (CSHM) 和日志收集。' 
---
= 验证 Cisco Nexus 9332D-GX2B 交换机上用于日志收集的 SSH
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
确认已在 Cisco Nexus 9332D-GX2B 交换机上启用 SSH，以支持以太网交换机运行状况监视器 (CSHM) 和日志收集功能。
