...
+
这link:https://hwu.netapp.com/["Hardware Universe"^]包含有关布线的更多信息。
...
* link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Software/ONTAP_OS/How_to_suppress_automatic_case_creation_during_scheduled_maintenance_windows["NetApp 知识库文章 1010449 ： How to suppress automatic case creation during scheduled maintenance windows."^]
...
+
这link:https://hwu.netapp.com/["Hardware Universe"^]包含有关您的平台的实际集群端口的最新信息。
