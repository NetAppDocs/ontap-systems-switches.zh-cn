...
summary: 在不中断操作的情况下更换 AFX 系统中有缺陷的 Cisco Nexus 9364D-GX2A 交换机。这是一个无中断的操作步骤。 
---
= 更换 AFX 系统中的 Cisco Nexus 9364D-GX2A 交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在不中断操作的情况下更换 AFX 系统中有缺陷的 Cisco Nexus 9364D-GX2A 交换机。此无中断程序（NDU）涉及准备替换交换机和恢复系统配置。
...
** 交换机的初始定制已完成，详见link:configure-complete-initial-setup-9364d.html["完成初始交换机设置"]。
+
