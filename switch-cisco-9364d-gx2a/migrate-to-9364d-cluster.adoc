...
summary: 您可以将ONTAP集群的旧Cisco集群交换机无中断地迁移到Cisco Nexus 9364d-gx2a 集群网络交换机。 
---
= 从较旧的Cisco交换机迁移到Cisco Nexus 9364D-GX2A 交换机
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以从较旧的Cisco集群交换机执行无中断迁移到Cisco Nexus 9364D-GX2A 集群网络交换机。
